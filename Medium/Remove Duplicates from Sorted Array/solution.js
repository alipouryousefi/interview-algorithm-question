function removeDuplicates(nums) {
    ...
    // Initialize pointers
    let k = 2; // Pointer to keep track of the next unique element position
    let prev = 1; // Pointer to keep track of the previous element
    let curr = 2; // Pointer to keep track of the current element
